...
import com.signumapp.service.JwtTokenService;
import com.signumapp.service.PostService;
import com.signumapp.service.UserService;
...
public class UserController {
    ...
    public ResponseEntity<?> getUserFollowerUser(@PathVariable("userId") Long userId) {   
        List<UserResponse> followingList = userService.getFollowerUsers(userId);
        return new ResponseEntity<>(followingList, HttpStatus.OK);
    }
