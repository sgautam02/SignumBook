...
export class UserService {
	...
	getAllUser():Observable<UserResponse[] | HttpErrorResponse>{
		return this.httpClient.get<UserResponse[] | HttpErrorResponse>(`${this.host}/get-all-user`)
	}
	...
	getUserFollower(userId: number): Observable<UserResponse[] | HttpErrorResponse> {

		console.log("calling get followers");
		
		return this.httpClient.get<UserResponse[] | HttpErrorResponse>(`${this.host}/users/${userId}/followers`);
	}
